...
var _chrisbuttery$slackm8$Model$Group = F2(
	function (a, b) {
...
var _chrisbuttery$slackm8$Helpers$targetSelectedIndex = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['target', 'selectedIndex']),
	_elm_lang$core$Json_Decode$int);
var _chrisbuttery$slackm8$Helpers$dasherize = function (str) {
...
var _chrisbuttery$slackm8$Helpers$createGroup = F3(
	function (name, group, i) {
		return {
			group: group,
			title: A2(
...
var _chrisbuttery$slackm8$Helpers$createGroups = F2(
	function (name, list) {
		return A2(
			_elm_lang$core$List$indexedMap,
			F2(
				function (i, lst) {
					return A3(_chrisbuttery$slackm8$Helpers$createGroup, name, lst, i);
				}),
			list);
	});
...
var _chrisbuttery$slackm8$Loader$animateElement = function (delay) {
	return A2(
...
var _chrisbuttery$slackm8$Loader$render = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_chrisbuttery$slackm8$Loader$animateElement('0s')
				])),
			A2(
			_elm_lang$svg$Svg$circle,
			_elm_lang$core$Native_List.fromArray(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_chrisbuttery$slackm8$Loader$animateElement('100ms')
				])),
			A2(
			_elm_lang$svg$Svg$circle,
			_elm_lang$core$Native_List.fromArray(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_chrisbuttery$slackm8$Loader$animateElement('300ms')
				])),
			A2(
			_elm_lang$svg$Svg$circle,
			_elm_lang$core$Native_List.fromArray(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_chrisbuttery$slackm8$Loader$animateElement('600ms')
				])),
			A2(
			_elm_lang$svg$Svg$circle,
			_elm_lang$core$Native_List.fromArray(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_chrisbuttery$slackm8$Loader$animateElement('800ms')
				])),
			A2(
			_elm_lang$svg$Svg$circle,
			_elm_lang$core$Native_List.fromArray(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_chrisbuttery$slackm8$Loader$animateElement('400ms')
				])),
			A2(
			_elm_lang$svg$Svg$circle,
			_elm_lang$core$Native_List.fromArray(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_chrisbuttery$slackm8$Loader$animateElement('700ms')
				])),
			A2(
			_elm_lang$svg$Svg$circle,
			_elm_lang$core$Native_List.fromArray(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_chrisbuttery$slackm8$Loader$animateElement('500ms')
				])),
			A2(
			_elm_lang$svg$Svg$circle,
			_elm_lang$core$Native_List.fromArray(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_chrisbuttery$slackm8$Loader$animateElement('200ms')
				]))
		]));
...
var _chrisbuttery$slackm8$Split$split = F2(
	function (i, list) {
		...
		if (_p0.ctor === '[]') {
			...
			return A2(
				...
				_p0,
				A2(
					_chrisbuttery$slackm8$Split$split,
					i,
...
var _chrisbuttery$slackm8$Shuffle$extractValueHelper = F3(
		...
		while (true) {
			...
			if (_p0._1.ctor === '[]') {
				...
				if (_p0._0 === 0) {
					...
					var _v1 = _p0._1._1,
						_v2 = index - 1,
						_v3 = A2(_elm_lang$core$List_ops['::'], _p0._1._0, accumulator);
					values = _v1;
					index = _v2;
					accumulator = _v3;
...
var _chrisbuttery$slackm8$Shuffle$extractValue = F2(
	function (values, index) {
		return A3(
			_chrisbuttery$slackm8$Shuffle$extractValueHelper,
			values,
			index,
			_elm_lang$core$Native_List.fromArray(
				[]));
	});
var _chrisbuttery$slackm8$Shuffle$shuffle = function (values) {
	var _p2 = values;
	if (_p2.ctor === '[]') {
		return A2(
			_elm_lang$core$Random$map,
		...
		var extractAndRecurse = function (index) {
			var _p4 = A2(_chrisbuttery$slackm8$Shuffle$extractValue, _p5, index);
			var randomHead = _p4._0;
			var remainder = _p4._1;
			var remainderGen = _chrisbuttery$slackm8$Shuffle$shuffle(remainder);
			return A2(
				_elm_lang$core$Random$map,
				function (randomTail) {
					return A2(_elm_lang$core$List_ops['::'], randomHead, randomTail);
				},
				remainderGen);
		};
		...
		return A2(_elm_lang$core$Random$andThen, randomIndexGenerator, extractAndRecurse);
	}
};

var _chrisbuttery$slackm8$Ports$modelChange = _elm_lang$core$Native_Platform.outgoingPort(
	'modelChange',
	function (v) {
		return {
...
var _chrisbuttery$slackm8$Ports$logExternal = function (value) {
	return _chrisbuttery$slackm8$Ports$logExternalOut(
		_elm_lang$core$Basics$toString(value));
};
...
var _chrisbuttery$slackm8$Update$decodeInviteMemberResponse = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		['ok']),
	_elm_lang$core$Json_Decode$bool);
var _chrisbuttery$slackm8$Update$decodeCreateChannelResponse = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['channel', 'id']),
	_elm_lang$core$Json_Decode$string);
var _chrisbuttery$slackm8$Update$decodeSmlAvatar = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['image_24']),
	_elm_lang$core$Json_Decode$string);
var _chrisbuttery$slackm8$Update$decodeLrgAvatar = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['image_32']),
	_elm_lang$core$Json_Decode$string);
var _chrisbuttery$slackm8$Update$decodeMembers = A7(
	_elm_lang$core$Json_Decode$object6,
	_chrisbuttery$slackm8$Model$Member,
...
var _chrisbuttery$slackm8$Update$inviteMember = F3(
	function (token, channel_id, user_id) {
		return A3(
			_elm_lang$core$Task$perform,
			_chrisbuttery$slackm8$Update$InviteMemberFail,
			_chrisbuttery$slackm8$Update$InviteMemberSuccess,
			A3(
				_evancz$elm_http$Http$post,
				_chrisbuttery$slackm8$Update$decodeInviteMemberResponse,
				A2(
					_elm_lang$core$Basics_ops['++'],
...
var _chrisbuttery$slackm8$Update$CreateChannelFail = function (a) {
	return {ctor: 'CreateChannelFail', _0: a};
};
var _chrisbuttery$slackm8$Update$createChannel = F4(
	function (idx, token, title, group) {
		return A3(
			_elm_lang$core$Task$perform,
			_chrisbuttery$slackm8$Update$CreateChannelFail,
			A2(_chrisbuttery$slackm8$Update$CreateChannelSuccess, group, token),
			A3(
				_evancz$elm_http$Http$post,
				_chrisbuttery$slackm8$Update$decodeCreateChannelResponse,
				A2(
					_elm_lang$core$Basics_ops['++'],
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						{ctor: '_Tuple2', _0: 'action--refresh', _1: true},
						{
						ctor: '_Tuple2',
						_0: 'hidden',
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_chrisbuttery$slackm8$Helpers$classNames(
						_elm_lang$core$Native_List.fromArray(
							['btn', 'btn--text'])),
						_elm_lang$html$Html_Events$onClick(_chrisbuttery$slackm8$Update$FetchMembers)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Refetch Team')
					]))
			]));
};
var _chrisbuttery$slackm8$View$renderHeader = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('slackm8')
				]))
		]));
var _chrisbuttery$slackm8$View$renderLoadingState = function (isLoading) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[_chrisbuttery$slackm8$Loader$render]));
};
var _chrisbuttery$slackm8$View$renderChannelActions = F2(
	function (groups, limit) {
		var isDisabled = (_elm_lang$core$Native_Utils.eq(
			groups,
			_elm_lang$core$Native_List.fromArray(
				[])) || _elm_lang$core$Native_Utils.eq(limit, 0)) ? true : false;
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('actions--channel')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$html$Html_Events$onClick(_chrisbuttery$slackm8$Update$InviteMembersToChannels)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Create and invite')
						]))
				]));
	});
var _chrisbuttery$slackm8$View$renderTokenForm = function (model) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('actions--token')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Events$onClick(_chrisbuttery$slackm8$Update$Close)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$placeholder('xoxp-123456...'),
								_elm_lang$html$Html_Events$onInput(_chrisbuttery$slackm8$Update$StoreToken)
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Fetch Team')
							]))
					]))
			]));
};
var _chrisbuttery$slackm8$View$renderGroupMember = function (member) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('member')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							['profile', 'u-mr-sml'])),
						_elm_lang$html$Html_Attributes$src(member.avatar_lrg)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(_elm_lang$core$Basics_ops['++'], '@', member.name))
					]))
			]));
};
var _chrisbuttery$slackm8$View$renderGroup = function (obj) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_chrisbuttery$slackm8$Helpers$classNames(
						_elm_lang$core$Native_List.fromArray(
							['group__title', 'u-mr-lrg']))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(obj.title)
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('group__members')
					]),
				A2(_elm_lang$core$List$map, _chrisbuttery$slackm8$View$renderGroupMember, obj.group))
			]));
};
var _chrisbuttery$slackm8$View$renderGroups = F2(
	function (title, groups) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
			...
			A2(
				_elm_lang$core$List$map,
				_chrisbuttery$slackm8$View$renderGroup,
				A2(_chrisbuttery$slackm8$Helpers$createGroups, title, groups)));
	});
var _chrisbuttery$slackm8$View$renderTeamMember = function (member) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_chrisbuttery$slackm8$Helpers$classNames(
						_elm_lang$core$Native_List.fromArray(
							['profile', 'profile--sml', 'u-mr-sml'])),
						_elm_lang$html$Html_Attributes$src(member.avatar_sml)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
...
var _chrisbuttery$slackm8$View$renderTeamList = F2(
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('team__title')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('team__members')
						]),
					A2(
						_elm_lang$core$List$map,
						function (member) {
							return _chrisbuttery$slackm8$View$renderTeamMember(member);
						},
						team)),
					_chrisbuttery$slackm8$View$renderLoadingState(isLoading)
				]));
	});
var _chrisbuttery$slackm8$View$renderDescription = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[
...
var _chrisbuttery$slackm8$View$optionValues = function (max) {
	return _elm_lang$core$Native_List.range(0, max);
};
var _chrisbuttery$slackm8$View$renderActions = function (model) {
	var isDisabled = _elm_lang$core$Native_Utils.eq(model.limit, 0) ? true : false;
	var selectEvent = A2(
		_elm_lang$html$Html_Events$on,
		'change',
		A2(_elm_lang$core$Json_Decode$map, _chrisbuttery$slackm8$Update$SetLimit, _chrisbuttery$slackm8$Helpers$targetSelectedIndex));
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('actions--main')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('actions--invite')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('actions--shuffle')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('inline-block'),
								_elm_lang$html$Html_Attributes$type$('text'),
								_elm_lang$html$Html_Attributes$placeholder('Type room name'),
								_elm_lang$html$Html_Events$onInput(_chrisbuttery$slackm8$Update$SetTitle)
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('select-group')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('select-group__label')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('Groups of')
									])),
								A2(
								_elm_lang$html$Html$select,
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('select-group__select'),
										selectEvent
									]),
								A2(
									_elm_lang$core$List$map,
										...
										return A2(
											...
											_elm_lang$core$Native_List.fromArray(
												[
													...
													_elm_lang$core$Native_Utils.eq(model.limit, val)),
									...
									_chrisbuttery$slackm8$View$optionValues(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									['btn', 'inline-block'])),
								_elm_lang$html$Html_Attributes$disabled(isDisabled),
								_elm_lang$html$Html_Events$onClick(_chrisbuttery$slackm8$Update$Shuffle)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
...
var _chrisbuttery$slackm8$View$renderMain = function (model) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_chrisbuttery$slackm8$View$renderActions(model),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'success', _1: true},
								{
								ctor: '_Tuple2',
								_0: 'hidden',
								_1: _elm_lang$core$Native_Utils.eq(model.success, false)
							},
								{
								ctor: '_Tuple2',
								_0: 'inline-block',
								_1: _elm_lang$core$Native_Utils.eq(model.success, true)
							}
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
...
var _chrisbuttery$slackm8$View$nothing = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[]));
var _chrisbuttery$slackm8$View$renderTeam = function (model) {
	var _p0 = model.team;
	if (_p0.ctor === 'Nothing') {
		return _chrisbuttery$slackm8$View$nothing;
	} else {
		return A2(_chrisbuttery$slackm8$View$renderTeamList, _p0._0, model.isLoading);
	}
};
var _chrisbuttery$slackm8$View$view = function (model) {
	var team = A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[]),
		model.team);
	var renderView = (_elm_lang$core$Native_Utils.eq(model.token, '') || _elm_lang$core$Native_Utils.eq(
		team,
		_elm_lang$core$Native_List.fromArray(
			[]))) ? _chrisbuttery$slackm8$View$renderTokenForm : _chrisbuttery$slackm8$View$renderMain;
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_chrisbuttery$slackm8$View$renderTeam(model),
...
var _chrisbuttery$slackm8$Subscriptions$subscriptions = function (_p0) {
	return _elm_lang$core$Platform_Sub$none;
};

var _chrisbuttery$slackm8$Main$init = function (savedModel) {
	return {
		ctor: '_Tuple2',
		_0: A2(_elm_lang$core$Maybe$withDefault, _chrisbuttery$slackm8$Model$model, savedModel),
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
var _chrisbuttery$slackm8$Main$update = F2(
	function (msg, model) {
		var _p0 = A2(_chrisbuttery$slackm8$Update$update, msg, model);
		...
		return {
			...
			_1: _elm_lang$core$Platform_Cmd$batch(
				_elm_lang$core$Native_List.fromArray(
					[
						_chrisbuttery$slackm8$Ports$logExternal(msg),
						nextCmd
					]))
		};
	});
var _chrisbuttery$slackm8$Main$main = {
	main: _elm_lang$html$Html_App$programWithFlags(
		{init: _chrisbuttery$slackm8$Main$init, view: _chrisbuttery$slackm8$View$view, update: _chrisbuttery$slackm8$Main$update, subscriptions: _chrisbuttery$slackm8$Subscriptions$subscriptions}),
					...
					function (error) {
						return A2(
							...
							function (groups) {
								return A2(
									_elm_lang$core$Json_Decode$andThen,
									A2(_elm_lang$core$Json_Decode_ops[':='], 'isLoading', _elm_lang$core$Json_Decode$bool),
									function (isLoading) {
										return A2(
											_elm_lang$core$Json_Decode$andThen,
											A2(_elm_lang$core$Json_Decode_ops[':='], 'limit', _elm_lang$core$Json_Decode$int),
											function (limit) {
												return A2(
													_elm_lang$core$Json_Decode$andThen,
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _chrisbuttery$slackm8$Main$main === 'undefined' ? null : _chrisbuttery$slackm8$Main$main);
